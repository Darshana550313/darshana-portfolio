      ...
      <div className="max-w-7xl mx-auto section-padding">
        ...
        <div className="text-center mb-16">
          ...
          <p className="reveal opacity-0 stagger-2 text-gray-600 max-w-2xl mx-auto">
            A passionate developer with a strong foundation in data science and software developer
          </p>
        </div>
          ...
          <div>
            <div className="reveal opacity-0 stagger-3 mb-8">
              ...
              <p className="text-gray-600 leading-relaxed text-justify">
                I'm an AI/ML Developer and Data Science enthusiast passionate about building intelligent systems powered by Machine Learning, Deep Learning, and Generative AI.
                I have completed B.Tech in Data Science, I have hands-on experience developing RAG-based AI chatbots, NLP applications, and full-stack web solutions. My expertise includes Python, TensorFlow, PyTorch, LangChain, SQL, and modern AI technologies.
                Through my internship at Earth Logicware Technologies, I've worked on AI workflow integration, database systems, automation, and software development. I enjoy transforming complex problems into practical, scalable solutions that create real-world impact.
              </p>
            </div>
            ...
            <div className="reveal opacity-0 stagger-4 space-y-4 mb-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Dr. Bapuji Salunkhe Institute of Engineering and Technology</p>
                </div>
              </div>
            </div>
